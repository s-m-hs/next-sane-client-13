...
export const metadata = {
  ...
  description:
    " فروشگاه اینترنتی صانع به عنوان یکی از پیشروترین مراکز فروش قطعات کامپیوتر و کالاهای دیجیتال به صورت آنلاین(وب سایت) وبه صورت آفلاین(فروشگاه فیزیکی) در ایران شناخته می‌شود. با ارائه محصولات متنوع از برندهای معتبر داخلی و خارجی، ارسال سریع به سراسر کشور و تضمین کیفیت، در خدمت مشتریان گرامی میباشد. ",
  icons: {
  ...
  return (
    <html lang="fa" dir="rtl">
      <Head>
        ...
        <meta
          name="description"
          content="کامپیوترصانع فعالیت خود را از سال 1380 در زمینۀ فروش قطعات کامپیوتر و کالاهای دیجیتال به صورت آنلاین از طریق وبسایت و آفلاین از طریق فروشگاه فیزیکی شروع نموده ..."
        />
        <meta property="og:title" content="فروشگاه صانع" />
        <meta property="og:image" content="../images/photo_2024-05-30_19-08-29.jpg" />
        {/* <meta name="enamad" content="9036150" /> */}
        <script

...
export default function LoginRight() {
  ...
  const customInputB = ({ events, props }) => (
    <input {...events} {...props} type="text" className="custom-otp-inputB" />
  );
  ...
  const alertC = () =>
    alertN(
      "center",
      "error",
      "  شماره همراه را به درستی وارد نشده است ...",
      1500
    );
  const alertD = () =>
    alertN(
      "center",
      "error",
      " رمز ورود باید بیشتر از 3 کاراکتر باشد...",
      1500
    );
  const alertF = () =>
    alertN("center", "error", " رمز ورود با رمز تکرار یکسان نیست  ...", 1500);
  const alertG = () =>
    alertN("center", "success", " رمز ورود با موفقیت تغییر کرد", 1500).then(
      (res) => {
        setShow(false);
        reset(setValue(""));
      }
  ...
  const alertH = () =>
    alertN("center", "success", "", 1500).then((res) => {
  ...
  const alertJ = () =>
    alertN("center", "success", "", 3000).then((res) => {
      sendMobToRecovery();
    });
  ...
  return (
    <div className={`${style.div_main} centerc`}>
      <img
        className={style.img}
        src="../../../../../images/register/photo_2024-08-05_16-37-06.jpg"
        alt="photo_2024"
      />
      ...
      <h2>
        حساب کاربری ندارید؟{" "}
        <Link onClick={() => setXtFlagSpinnerShow(true)} href={"/register"}>
          ثبت نام کنید ...
        </Link>
      </h2>
      ...
      <div className={`${style.div_input} centerc`}>
        ...
        >
          ...
          {flagHamkar && (
            <div className={`${style.div_input_B} centerr`}>
              ...
              <div className="login_label_float">
                ...
                <button className={`${style.help_Button} btn btn-warning`}>
                  راهنمایی
                </button>
              </div>
              {/* <EyeSlash className={style.eyeicon} size={24} color="#19a5af" /> */}
          ...
          <h3 className={`${style.h3} `} onClick={() => setShow(true)}>
      ...
      <>
        ...
        >
          ...
          <Modal.Body>
            {!recoveryFlag && !onlyOkFlag ? (
              <div
                className={`${style.card_div} card flex justify-content-center`}
              >
                <style scoped></style>
              ...
              >
                <InputOtp
                  value={tokenC}
                  length={6}
                  onChange={(e) => setTokensC(e.value)}
                  integerOnly
                  inputTemplate={customInputB}
                />
                ...
                <button
                  ...
                  className={
                    tokenC.length == 6
                      ? `${style.buttonB} btn btn-primary mt-3`
                      : `${style.buttonB2} btn btn-primary mt-3`
                  }
                  onClick={() => {
                    alertH();
                    // classRefB.current.classList.remove( `${style.buttonB}`)
            ...
            <>
              ...
              >
                ...
                <button
                  className={`${style.buttonB} btn btn-info mt-2`}
      ...
      >تایید</button> */}
          ...
          <Modal.Footer>
            ...
            {!recoveryFlag && !onlyOkFlag && (
              <Button variant="primary" onClick={() => alertJ()}>
                تایید
              </Button>
            )}

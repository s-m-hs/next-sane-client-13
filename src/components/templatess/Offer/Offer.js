...
BasketOffer()
  ...
  return (
    <div className='container' >
        <div className={`row row-cols-4 centerr pt-4 ${style.products_card } boxSh `}>


{offProduct.length!==0 && offer==1 &&  offProduct.map((item=>(
    <div key={item.id}
  ...
  >
                   <CardC
                      ...
                      // parentId={parentId}
                      id={item.id}
                      imgSrc={item.smallImage} title={item.name}

...
export default function RegisterRight() {
  ...
  const alertA = () =>
    alertN("center", "success", "ثبت نام با موفقیت انجام شد", 1500).then(
      (res) => {
        setXtFlagLogin(true);
        reset(setValue(""));
        router.push("/");
  ...
  const alertD = () =>
    alertN("center", "success", "کد تایید برای شما ارسال شد", 1500).then(
      (res) => {
        setFlagInput(true);
        reset(setValue(""));
      }
  ...
  const alertC = () =>
    alertN("center", "error", "  شماره همراه به درستی وارد نشده است ...", 1500);
  const alertE = () =>
    alertN("center", "error", "  رمز عبور و تکرار آن یکسان نیست...", 1500);
  ...
  return (
    <div className={`${style.div_main} centerc`}>
      <img
        className={style.img}
        src="../../../../../images/register/8380015.jpg"
        alt="image"
      />
      ...
      <h1>
        ...
        <Link onClick={() => setXtFlagSpinnerShow(true)} href={"/login"}>
          وارد شوید...
        </Link>
      </h1>
                  ...
                  <input
                    ...
                    {...register(`password`, {
                      ...
                      minLength: {
                        value: 4,
                        message:
                          "رمز عبور وارد شده نباید کمتر از 4 کاراکتر باشد ", // JS only: <p>error message</p> TS only support string
                      },
                    })}
                  />
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className={
                    tokenB.length == 6
                      ? `${style.buttonB} btn btn-primary`
                      : `${style.buttonB2} btn btn-primary`
                  }
                >
                  ارسال کد تایید
                </button>

          ...
          <div className={`container ${style.container}`}>
            <div className={`row ${style.row}`}>
              <div className={`col ${style.col} boxSh`}>
                <div className="row">
                  <div
                    className={`col-md-2 centerc ${style.warrantyCod_col_right}`}
                  >
                    <button
                    ...
                    {warantyArray?.length != 0 &&
                      warantyArray?.map((item) => (
                        <button
                          className={
                            item.type == 1
                              ? `btn btn-outline-info m-1 ${style.button_code}`
                              : `${style.btn_hide}`
                          }
                          onClick={() => {
                    ...
                    <div className="row">
                            ...
                            {warantyArray?.length != 0 &&
                              warantyArray?.map((item) => (
                                <button
                                  className={
                                    item.type == 1
                                      ? `btn btn-outline-info m-1 ${style.button_codeB}`
                                      : `${style.btn_hide}`
                                  }
                                  onClick={() => {
                                    setWarrantyDetail(item);
                      ...
                      >
                        ...
                        <div>
                          ...
                          <DataFormatUnHoure
                            dateString={`${warrantyDetail?.recievedDate}`}
                          />
                        </div>
                      </button>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div
                          className={`login_label_float ${style.input} centerr`}
                        >
                          <input disabled value={warrantyDetail?.productName} />
                      ...
                      <div className="col-md-6 centerc">
                        <div className={`${style.date_div} centerc`}>
                          ...
                          <DataFormatUnHoure
                            dateString={`${warrantyDetail?.guaranteeCompany}`}
                          />
                        </div>
                      </div>
                      <div className="col-md-6">
                    ...
                    <div className="row">
                      <div className="col-12">
                        <div className={`${style.textarea_div} centerr`}>
                          <label> ایراد دستگاه طبق اظهار مشتری:</label>
                          <textarea
